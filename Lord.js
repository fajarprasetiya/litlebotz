...
Minat? Pm wa.me/${owner_number}`,
					...
					succes: '```[ ✓ ]``` Sukses Lord',
					only: {
						personal: 'Only Private Chat Tod',
						admin: 'Khusus Admin Group Tod',
						group: 'Khusus Dalam Grup Todd',
						 prem: 'Khusus User Premium Tod',
						owner: 'Khusus Owner Bot Todd',
						 }
					} 
...
_Tunggu Proses Upload Media_`
						...
						case 'afk':
									if (!isGroup) return reply(mess.only.group)
									if (isAfkOn) return reply('Kamu dalam mode afk Tod')
